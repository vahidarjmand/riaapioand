// Font family
const light = 'iranyekanweblight';
const regular = 'iranyekanwebregular';
const medium = 'iranyekanwebregular';
const bold = 'iranyekanwebbold';
const number = 'IRANYekanDigits';
